...
$query = $_POST['query'];
$sql = "SELECT * FROM femmes WHERE titre LIKE '%$query%'  ORDER BY date_publication DESC";
...
<td>
<a href='modifier_femme.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='ti ti-edit'></i></a>
