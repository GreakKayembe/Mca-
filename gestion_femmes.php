...
<head>
    ...
    <title>Gestion de la ligue des femmes </title>
...
<div class="container mt-4">
    <h2 class="text-center">Gestion de la Ligue des femmes</h2>

    <a href="ajouter_femme.php" class="btn btn-success" ><i class="ti ti-plus"></i>Ajouter</a>  
    ...
    <thead class="table-dark">
        ...
        <?php
            $sql = "SELECT * FROM femmes ORDER BY date_publication DESC";
            ...
            while ($row = $result ->fetch_assoc()) {
                        ...
                        <td>
                            <a href='modifier_femme.php?id={$row['id']}' class='btn btn-warning btn-sm' style='font-size:10px'><i class='ti ti-edit'></i></a>
    ...
    $(document).ready(function() {
        ...
        $(".delete-btn").click(function() {
            ...
            if (confirm("Voulez-vous vraiment supprimer cette actualité ?")) {
                $.post("delete_femme.php", { id: id }, function(response) {
                    location.reload();
                });
            }
        });
