...
if (isset($_POST['ajouter'])) {
    ...
    $conn->query("INSERT INTO diasporas (titre) VALUES ('$titre')");
    $id_diaspo = $conn->insert_id;
    ...
    foreach ($paragraphes as $index => $para) {
        ...
        $conn->query("INSERT INTO contenus_diaspora (diaspora_id, paragraphe, image_path, ordre) 
                      VALUES ($id_diaspo, '$para', '$img_path', $index)");
    }

    echo "<div class='alert alert-success'>Actualité enregistrée avec succès.</div>";
    header("Location:gestion_diasporas.php");
}
...
<div class="container mt-5">
    <h2>Ajouter une Actualité de La diaspora</h2>
