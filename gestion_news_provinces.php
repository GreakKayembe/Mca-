...
<head>
    ...
    <title>Gestion News province </title>
...
<div class="container mt-4">
    <h2 class="text-center">Gestion News province</h2>

    <a href="ajouter_news_provinces.php" class="btn btn-success" ><i class="ti ti-plus"></i>Ajouter</a>  
    ...
    <table class="table table-bordered table-hover">
        ...
        <?php
            $sql = "SELECT * FROM news_provinces ORDER BY date_publication DESC";
            ...
            while ($row = $result ->fetch_assoc()) {
                        ...
                        <td>
                            <a href='modifier_news_province.php?id={$row['id']}' class='btn btn-warning btn-sm' style='font-size:10px'><i class='ti ti-edit'></i></a>
    ...
    $(document).ready(function() {
        ...
        $(".delete-btn").click(function() {
            ...
            if (confirm("Voulez-vous vraiment supprimer cette actualité ?")) {
                $.post("delete_news_province.php", { id: id }, function(response) {
                    location.reload();
                });
            }
        });
