...
$actu = $conn->query("SELECT * FROM diasporas WHERE id = $id")->fetch_assoc();
...
<div class="container mt-5">
    ...
    <form action="modifier_diaspora_action.php" method="POST" enctype="multipart/form-data">
        ...
        <a href="gestion_diasporas.php" class="btn btn-secondary"><i class='ti ti-arrow-back'></i>Retour</a>
    </form>
</div>
</body>
</html>
