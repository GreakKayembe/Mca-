...
$actu = $conn->query("SELECT * FROM actualites WHERE id = $id")->fetch_assoc();
$contenus = $conn->query("SELECT * FROM actualite_contenus WHERE actualite_id = $id ORDER BY ordre");
?>
...
<div class="container mt-5">
    ...
    <form action="modifier_actualite_action.php" method="POST" enctype="multipart/form-data">
        ...
        <a href="gestion_actualites.php" class="btn btn-secondary"><i class='ti ti-arrow-back'></i>Retour</a>
    </form>
</div>
</body>
</html>
