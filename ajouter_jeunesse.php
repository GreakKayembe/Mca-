...
if (isset($_POST['ajouter'])) {
    ...
    $conn->query("INSERT INTO jeunesses (titre) VALUES ('$titre')");
    $id_jeunesse = $conn->insert_id;
    ...
    foreach ($paragraphes as $index => $para) {
        ...
        $conn->query("INSERT INTO contenus_jeunesse (jeunesse_id, paragraphe, image_path, ordre) 
                      VALUES ($id_jeunesse, '$para', '$img_path', $index)");
    }

    echo "<div class='alert alert-success'>Actualité enregistrée avec succès.</div>";
    header("Location:gestion_jeunesse.php");
}
...
<div class="container mt-5">
    <h2>Ajouter une Actualité de la Jeunesse</h2>
