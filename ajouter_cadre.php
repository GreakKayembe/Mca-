...
if (isset($_POST['ajouter'])) {
    ...
    $conn->query("INSERT INTO cadres (titre) VALUES ('$titre')");
    $id_cadre = $conn->insert_id;
    ...
    foreach ($paragraphes as $index => $para) {
        ...
        $conn->query("INSERT INTO contenus_cadres (cadre_id, paragraphe, image_path, ordre) 
                      VALUES ($id_cadre, '$para', '$img_path', $index)");
    }

    echo "<div class='alert alert-success'>Actualité enregistrée avec succès.</div>";
    header("Location:gestion_cadres.php");
}
...
<div class="container mt-5">
    <h2>Ajouter une actualité des cadres</h2>
