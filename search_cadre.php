...
$query = $_POST['query'];
$sql = "SELECT * FROM cadres WHERE titre LIKE '%$query%' ORDER BY date_publication DESC";
...
<td>
<a href='modifier_cadre.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='ti ti-edit'></i></a>
