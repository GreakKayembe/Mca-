...
$query = $_POST['query'];
$sql = "SELECT * FROM diasporas WHERE titre LIKE '%$query%'  ORDER BY date_publication DESC";
...
<td>
<a href='modifier_diaspora.php?id={$row['id']}' class='btn btn-warning btn-sm'><i class='ti ti-edit'></i></a>
