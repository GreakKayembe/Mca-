...
<div class="container mt-4">
    <h2 class="text-center">Gestion des Actualités Diaspora</h2>

    <a href="ajouter_diaspora.php" class="btn btn-success" ><i class="ti ti-plus"></i>Ajouter</a>  
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody id="actualiteTable" style='font-size:10px'>
            <?php
            $sql = "SELECT * FROM diasporas ORDER BY date_publication DESC";
            ...
            while ($row = $result ->fetch_assoc()) {
                        ...
                        <td>
                            <a href='modifier_diaspora.php?id={$row['id']}' class='btn btn-warning btn-sm' style='font-size:10px'><i class='ti ti-edit'></i></a>
    ...
    $(document).ready(function() {
        ...
        $(".delete-btn").click(function() {
            ...
            if (confirm("Voulez-vous vraiment supprimer cette actualité ?")) {
                $.post("delete_diaspora.php", { id: id }, function(response) {
                    location.reload();
                });
            }
        });
