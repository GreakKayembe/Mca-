...
$actu = $conn->query("SELECT * FROM femmes WHERE id = $id")->fetch_assoc();
$contenus = $conn->query("SELECT * FROM contenus_femme WHERE femme_id = $id ORDER BY ordre");
?>
...
<div class="container mt-5">
    ...
    <form action="modifier_femme_action.php" method="POST" enctype="multipart/form-data">
        ...
        <a href="gestion_femmes.php" class="btn btn-secondary"><i class='ti ti-arrow-back'></i>Retour</a>
    </form>
</div>
</body>
</html>
