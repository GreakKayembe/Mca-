...
<div class="container mt-4">
    ...
    <a href="ajouter_actualite.php" class="btn btn-success" ><i class="ti ti-plus"></i>Ajouter</a>  
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody id="actualiteTable" style='font-size:10px'>
            ...
            while ($row = $result ->fetch_assoc()) {
                        ...
                        <td>
                            <a href='modifier_actualite.php?id={$row['id']}' class='btn btn-warning btn-sm' style='font-size:10px'><i class='ti ti-edit'></i></a>
    ...
    $(document).ready(function() {
        ...
        $(".delete-btn").click(function() {
            ...
            if (confirm("Voulez-vous vraiment supprimer cette actualité ?")) {
                $.post("delete_actualite.php", { id: id }, function(response) {
                    location.reload();
                });
            }
        });
