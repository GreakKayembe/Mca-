...
$actu = $conn->query("SELECT * FROM jeunesses WHERE id = $id")->fetch_assoc();
...
<div class="container mt-5">
    ...
    <form action="modifier_jeunesse_action.php" method="POST" enctype="multipart/form-data">
        ...
        <a href="gestion_jeunesse.php" class="btn btn-secondary"><i class='ti ti-arrow-back'></i>Retour</a>
    </form>
</div>
</body>
</html>
