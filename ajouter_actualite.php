...
if (isset($_POST['ajouter'])) {
    ...
    $conn->query("INSERT INTO actualites (titre) VALUES ('$titre')");
    $id_actu = $conn->insert_id;
    ...
    foreach ($paragraphes as $index => $para) {
        ...
        $conn->query("INSERT INTO actualite_contenus (actualite_id, paragraphe, image_path, ordre) 
                      VALUES ($id_actu, '$para', '$img_path', $index)");
    }
