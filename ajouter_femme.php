...
if (isset($_POST['ajouter'])) {
    ...
    $conn->query("INSERT INTO femmes (titre) VALUES ('$titre')");
    $id_femme = $conn->insert_id;
    ...
    foreach ($paragraphes as $index => $para) {
        ...
        $conn->query("INSERT INTO contenus_femme (femme_id, paragraphe, image_path, ordre) 
                      VALUES ($id_femme, '$para', '$img_path', $index)");
    }

    echo "<div class='alert alert-success'>Actualité enregistrée avec succès.</div>";
    header("Location:gestion_femmes.php");
}
...
<div class="container mt-5">
    <h2>Ajouter une Actualité de la ligue des femmes</h2>
